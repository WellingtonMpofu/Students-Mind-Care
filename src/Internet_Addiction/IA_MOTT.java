 ...
 * @author Wellington
 */
public class IA_MOTT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(60, 80, 850, 260);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>MODERATE RISK</p>" + "<br/>"
                                       + "Your results indicate that you are an average online user. You may surf the web too "
                                       + "<br/>" + "long at times but you have control over your usage. It will be easier to maintain your " 
                                       + "<br/>" + "habits and know when you are developing an addiction if you know more about "
                                       + "<br/>" + "internet addiction. The links below will lead you to sites that will help you understand " 
                                       + "<br/>" + "causes, what to avoid and its treatment .If you notice your symptoms getting worse at some   "
                                       + "<br/>" + "point in time do not hesitate to visit your school counsellor or any mental health "
                                       + "<br/>" + " professional who will be in a better position to help you with what you may be going through."
                                + " </p>"
