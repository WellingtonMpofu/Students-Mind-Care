 ...
 * @author Wellington
 */
public class IA_Never extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>VERY LOW RISK</p>" + "<br/>"
                                       + "Your results indicate that you have no, or only a few symptoms of internet addiction "
                                       + "<br/>" + "disorder. Your online presence is lower than that of an average online user and you " 
                                       + "<br/>" + "seem to have control over your usage. If you want to know more about internet  "
                                       + "<br/>" + "addiction we suggest you visit the links below. And if you notice any change in your " 
                                       + "<br/>" + "habits after this make sure to visit your school counsellor or any mental health  "
                                       + "<br/>" + "professional as well as anyone who is supporting you."
