...
public class Decision_Class extends JFrame{
    ...
    IA_Window2 dw2 = new IA_Window2();
    IA_Window3 dw3 = new IA_Window3();
    IA_Window4 dw4 = new IA_Window4();
    IA_Window5 dw5 = new IA_Window5();
    IA_Window6 dw6 = new IA_Window6();
    IA_Window7 dw7 = new IA_Window7();
    IA_Window8 dw8 = new IA_Window8();
    IA_Window9 dw9 = new IA_Window9();
    IA_Window10 dw10 = new IA_Window10();
    IA_Never DN = new IA_Never();
    IA_SOTT DS = new IA_SOTT();
    IA_MOTT DM = new IA_MOTT();
    IA_AOTT DA = new IA_AOTT();
