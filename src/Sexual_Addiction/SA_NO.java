 ...
 * @author Wellington
 */
public class SA_NO extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            int x = st.executeUpdate("update Table1 set comments ='"+comment+"' where User_ID = ");
            if(x==1){
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        this.jLabel3.setText("<html> "
                                + "<p> " + "<br/>" + "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>LOW RISK</p>" + "<br/>" 
                                       + "Your results indicate that you have no, or very few symptoms of sexual addiction. "
                                       + "<br/>" + "We suggest you visit the sites below to better understand causes, symptoms and " 
                                       + "<br/>" + "treatment of sexual addiction. If symptoms get worse make an effort to visit your "
                                       + "<br/>" + "school counsellor or any mental health professional who will be in a better position " 
                                       + "<br/>" + "to help you in what you may be going through."
