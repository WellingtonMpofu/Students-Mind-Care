...
import Depression.Depression_Window9;
 ...
 * @author Wellington
 */
public class SA_Window9 extends javax.swing.JFrame {

    /**
     * Creates new form Depression_Window9
     */
    public SA_Window9() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton_undo.setBounds(900, 360, 250, 42);
        ...
        jLabel1.setText("Have you ever tried and failed to stop specific sexual behaviours?");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(720, 30, 795, 60);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Wellington\\Documents\\INFORMATICS\\Part 2.1\\Human Computer Interaction [SCI 2102]\\Research\\Psychology App\\Sex Pics\\Sex 9.jpg")); // NOI18N
        jPanel1.add(jLabel2);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        SA_Window10 dw = new SA_Window10();
        dw.setVisible(true);
        setVisible(false);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel1.setText("<html> "
                                + "<p> Have you ever tried and failed to stop specific "
                                       + "<br/>" + "sexual behaviours?"
                                + " </p>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Depression_Window9.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Depression_Window9().setVisible(true);
            }
        });
    }
