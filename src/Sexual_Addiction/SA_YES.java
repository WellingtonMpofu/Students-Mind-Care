 ...
 * @author Wellington
 */
public class SA_YES extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("https://www.medicalnewstoday.com/articles/182473");
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(60, 330, 417, 34);

        jLabel2.setFont(new java.awt.Font("Tahoma", 2, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2945841/");
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(60, 380, 417, 34);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> " + "<br/>" + "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>HIGH RISK</p>" + "<br/>" 
                                       + "Your results indicate that you are at high risk of suffering from sexual addiction."
                                       + "<br/>" + "But your symptoms indicate that this may be interfering with your everyday tasks," 
                                       + "<br/>" + "your relationships and your schoolwork. This may not mean you have sexual "
                                       + "<br/>" + "addiction but visiting your school counsellor or any mental health professional will" 
                                       + "<br/>" + "let you know for sure. Getting help may be challenging but it will eventually make "
                                       + "<br/>" + "a difference in your quality of life. "
                                       + "<br/>" 
                                       + "<br/>" + "Visit the sites below for tips on how you can overcome sexual addiction:"
                                + " </p>"
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        try{
            Desktop.getDesktop().browse(new URI("https://www.medicalnewstoday.com/articles/182473"));
        }
    ...
    private void jLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseEntered
        String text = "https://www.medicalnewstoday.com/articles/182473";
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        try{
            Desktop.getDesktop().browse(new URI("https://www.psychguides.com/behavioral-disorders/sex-addiction/"));
        }
        catch(IOException | URISyntaxException e1){
            e1.printStackTrace();
        }
    ...
    private void jLabel2MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseEntered
        String text = "https://www.psychguides.com/behavioral-disorders/sex-addiction/";
