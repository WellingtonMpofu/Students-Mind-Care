 ...
 * @author Wellington
 */
public class Depression_Window2 extends javax.swing.JFrame {

    /**
     * Creates new form Depression_Window21
     */
    public Depression_Window2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Have you recently lost interest in things you loved doing?");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(730, 40, 680, 70);
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Wellington\\Documents\\INFORMATICS\\Part 2.1\\Human Computer Interaction [SCI 2102]\\Research\\Psychology App\\Depression\\Depr 2.jpg")); // NOI18N
        jPanel1.add(jLabel2);
...
// ---------- GLOBAL VARIABLES ---------------------
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel1.setText("<html> "
                                + "<p> Have you recently lost interest in things you loved"
                                       + "<br/>" + "doing?"
                                + " </p>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Depression_Window2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Depression_Window2().setVisible(true);
            }
        });
    }
