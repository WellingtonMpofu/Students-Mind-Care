 ...
 * @author Wellington
 */
public class DC_MOTT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel6);
        jLabel6.setBounds(60, 80, 850, 250);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel6.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>MODERATE RISK</p>" + "<br/>"
                                       + "Your results indicate that you may be experiencing symptoms of moderately severe "
                                       + "<br/>" + "depression. These symptoms may be making it hard to manage relationships, your" 
                                       + "<br/>" + "school work and everyday tasks. Visiting a mental health professional or your "
                                       + "<br/>" + "school counsellor will help you understand what you are better going through and " 
                                       + "<br/>" + "they will be able to better diagnose you. We suggest you visit the following sites "
                                       + "<br/>" + "below which will help you understand the causes, symptoms of depression so you "
                                       + "<br/>" + "better monitor your symptoms."
                                + " </p>"
