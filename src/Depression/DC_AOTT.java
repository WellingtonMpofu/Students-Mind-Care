 ...
 * @author Wellington
 */
public class DC_AOTT extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
         this.jLabel6.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>HIGH RISK</p>" + "<br/>"
                                       ...
                                       + "<br/>" + "These may be greatly interfering with your relationships, school work and everyday " 
                                       + "<br/>" + "tasks. These results may not necessarily mean you have depression but visiting your "
                                       + "<br/>" + "school counsellor or any mental health professional will help you know for sure. " 
                                       + "<br/>" + "Getting help may be challenging but it will eventually make a difference in your "
                                       + "<br/>" + "quality of life. "
                                       + "<br/>" 
                                       + "<br/>" + "Visit the sites below on tips on how you can overcome depression:"
                                + " </p>"
