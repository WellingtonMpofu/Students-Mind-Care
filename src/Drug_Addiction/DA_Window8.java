...
import Depression.Depression_Window8;
 ...
 * @author Wellington
 */
public class DA_Window8 extends javax.swing.JFrame {

    /**
     * Creates new form Depression_Window8
     */
    public DA_Window8() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton_undo.setBounds(900, 360, 249, 40);
        ...
        jLabel1.setText("Drugs have started negatively affecting my school and everything around me");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(730, 30, 920, 60);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Wellington\\Documents\\INFORMATICS\\Part 2.1\\Human Computer Interaction [SCI 2102]\\Research\\Psychology App\\Drugs\\Drugs 8.jpg")); // NOI18N
        jPanel1.add(jLabel2);
...
// ---------- GLOBAL VARIABLES ---------------------
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "All done, Click OK to see results", "Test Complete", JOptionPane.INFORMATION_MESSAGE);
        Decision_Class dc = new Decision_Class();
        dc.getDecision();

//        DA_TRUE dw = new DA_TRUE();
//        try{
//            if(dc.d1.contains("T") && dc.d3.contains("T") && dc.d5.contains("T") && dc.d7.contains("T")){
//            dw.setVisible(true);
//            setVisible(false);
...
//        }
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel1.setText("<html> "
                                + "<p> Drugs have started negatively affecting my school"
                                       + "<br/>" + "and everything around me"
                                + " </p>"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Depression_Window8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Depression_Window8().setVisible(true);
            }
        });
    }
