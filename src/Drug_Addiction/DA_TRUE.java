 ...
 * @author Wellington
 */
public class DA_TRUE extends javax.swing.JFrame {
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>HIGH RISK</p>" + "<br/>"
                                       + "Your results indicate that you are at high risk of having alcohol or drug abuse "
                                       + "<br/>" + "addiction disorder. These symptoms may negatively be impacting your life and " 
                                       + "<br/>" + "causing many problems in your day to day life. These results do not mean you have "
                                       + "<br/>" + "the disorder but we suggest you visit a mental health professional or your school " 
                                       + "<br/>" + "counsellor who will better diagnose you.Getting help may be challenging but it will "
                                       + "<br/>" + "eventually make a huge difference in your quality of life."
                                       + "<br/>" 
                                       + "<br/>" + "Visit the sites below on tips on how you can overcome alcohol/drug addiction:"
                                + " </p>"
