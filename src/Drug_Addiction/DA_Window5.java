 ...
 * @author Wellington
 */
public class DA_Window5 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("A family member or friend has confronted me about my drinking or drugs use");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(720, 30, 920, 70);

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Wellington\\Documents\\INFORMATICS\\Part 2.1\\Human Computer Interaction [SCI 2102]\\Research\\Psychology App\\Drugs\\Drugs 5.jpg")); // NOI18N
        jPanel1.add(jLabel2);
...
// ---------- GLOBAL VARIABLES ---------------------
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel1.setText("<html> "
                                + "<p> A family member or friend has confronted me about "
                                       + "<br/>" + "my drinking or drugs use"
                                + " </p>"
