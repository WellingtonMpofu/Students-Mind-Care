 ...
 * @author Wellington
 */
public class AN_AOTT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("https://www.mentalhealth.org.uk/publications/overcome-fear-anxiety");
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(60, 340, 527, 34);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 15)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("https://www.verywellmind.com/breaking-the-anxiety-cycle-1392987");
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(60, 380, 527, 34);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        try{
            Desktop.getDesktop().browse(new URI("https://www.mentalhealth.org.uk/publications/overcome-fear-anxiety"));
        }
    ...
    private void jLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseEntered
        String text = "https://www.mentalhealth.org.uk/publications/overcome-fear-anxiety";
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>HIGH RISK</p>" + "<br/>"
                                       + "Your results indicate that you are experiencing symptoms of severe anxiety. These "
                                       + "<br/>" + "symptoms may be interfering with your school, relationships and everyday tasks. " 
                                       + "<br/>" + "These results may not mean you have anxiety but you might be at high risk of having  "
                                       + "<br/>" + "it. Only your school counsellor or mental health professional can tell you for sure so " 
                                       + "<br/>" + "make an effort to see them. Getting help may be challenging but it will eventually  "
                                       + "<br/>" + "make a huge difference in your quality of life. "
                                       + "<br/>" 
