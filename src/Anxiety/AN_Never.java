 ...
 * @author Wellington
 */
public class AN_Never extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(60, 390, 440, 34);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(60, 350, 420, 34);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>VERY LOW RISK</p>" + "<br/>"
                                       + "These results indicate that you have no or very few symptoms of anxiety. If you notice "
                                       + "<br/>" + "your symptoms getting worse make an effort to visit your school counsellor or any " 
                                       + "<br/>" + "mental health professional who will be in a better position to help you with what you  "
                                       + "<br/>" + "may be going through. We suggest you visit the following sites to know about the " 
                                       + "<br/>" + "symptoms, causes and treatment of anxiety so that you are in a better position to "
                                       + "<br/>" + "monitor it."
