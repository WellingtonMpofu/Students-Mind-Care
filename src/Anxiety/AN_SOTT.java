 ...
 * @author Wellington
 */
public class AN_SOTT extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("https://www.healthline.com/health/anxiety#:~:text=Anxiety%20is%20your%20body's%20natural,to%20feel%20fearful%20and%20nervous");
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(60, 340, 430, 34);
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(60, 380, 440, 34);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        try{
            Desktop.getDesktop().browse(new URI("https://www.healthline.com/health/anxiety#:~:text=Anxiety%20is%20your%20body's%20natural,to%20feel%20fearful%20and%20nervous"));
        }
    ...
    private void jLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseEntered
        String text = "https://www.healthline.com/health/anxiety#:~:text=Anxiety%20is%20your%20body's%20natural,to%20feel%20fearful%20and%20nervous";
    ...
    private void jLabel2MouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseExited
        String text = "https://www.webmd.com/anxiety-panic/guide/anxiety-disorders";
        this.jLabel2.setText(text);        // TODO add your handling code here:
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        this.jLabel3.setText("<html> "
                                + "<p> "+ "<p style=\font-size:1.5em; font-family:'Times New Roman', Times, sans-serif; font-variant:small-caps>LOW RISK</p>" + "<br/>"
                                       + "Your results indicate that you may be experiencing symptoms of mild anxiety. While "
                                       + "<br/>" + "these symptoms are not likely to have a major impact on your life it is necessary to  " 
                                       + "<br/>" + "monitor them. We suggest you visit the sites below so that you are in a better position "
                                       + "<br/>" + "to do monitor your symptoms. But once you notice your symptoms getting worse  " 
                                       + "<br/>" + "make an effort to visit your school counsellor or any mental health professional who "
                                       + "<br/>" + "will be in a better position to help you with what you may be going through."
                                       + "<br/>" 
                                       + "<br/>" + "Visit the following sites below for tips on how to overcome anxiety:"
                                + " </p>"
